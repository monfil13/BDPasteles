...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2023 a las 05:56:11
...
--
-- Estructura de tabla para la tabla `modelo_pastels`
--

CREATE TABLE `modelo_pastels` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
(3, 'monfil', 'davilesmonfil34@gmail.com', NULL, '$2y$10$lysSlmrXC6bKVyP6EDj66uWfszQ36S3FuUyqjfd.h9radJ7zU7jva', NULL, '2023-12-04 03:48:06', '2023-12-04 03:48:06');
...
--
-- Indices de la tabla `modelo_pastels`
--
ALTER TABLE `modelo_pastels`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `modelo_pastels`
--
ALTER TABLE `modelo_pastels`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
